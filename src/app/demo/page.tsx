          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <GlowCard
                ...
                viewport={{ once: true }}
                className="p-[2px] rounded-xl transition duration-300 group cursor-pointer"
                onClick={() => {}}
              >
                <div className="bg-white/5 rounded-xl p-8 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 h-full">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <GlowCard
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="p-[2px] rounded-xl transition duration-300"
            >
              <div className="bg-black/50 border border-white/20 rounded-xl overflow-hidden hover:border-white/40 transition-all duration-300">
            ...
            <GlowCard
              ...
              className="p-[2px] rounded-xl transition duration-300"
            >
              <div className="bg-white/5 rounded-xl p-8 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-all duration-300 h-full">
      ...
      <section ref={downloadWrapperRef} className="relative py-32 px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <GlowCard
              radius={120}
              className="p-[2px] rounded-2xl transition duration-300"
            >
              <div className="bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm overflow-hidden hover:border-white/20 transition-all duration-300 relative">
                <canvas
                  ref={canvasRef}
          ...
          >
            {[
              ...
              <GlowCard
                ...
                className="p-[2px] rounded-xl transition duration-300 group cursor-pointer"
              >
                <div className="text-center p-6 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300 h-full">
